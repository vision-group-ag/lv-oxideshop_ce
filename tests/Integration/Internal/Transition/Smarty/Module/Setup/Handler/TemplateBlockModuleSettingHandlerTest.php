...
namespace OxidEsales\EshopCommunity\Tests\Integration\Internal\Transition\Smarty\Module\Setup\Handler;
...
final class TemplateBlockModuleSettingHandlerTest extends IntegrationTestCase
{
    ...
    public function testHandlingOnModuleActivation(): void
    {
        ...
        $settingHandler = $this->get(ModuleConfigurationHandlerInterface::class);
